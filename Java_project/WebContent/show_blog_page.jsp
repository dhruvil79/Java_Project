...
<html>
    <head>
        ...
        <title><%= p.getpTitle()%> || TechBlog by Learn Code with Dhruvil </title>
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav mr-auto">
                    <li class="nav-item active">
                        <a class="nav-link" href="profile.jsp"> <span class="	fa fa-bell-o"></span> LearnCode with Dhruvil <span class="sr-only">(current)</span></a>
                    </li>
                            ...
                            <div class="row my-3 row-user">
                                <div class="col-md-8">
                                    ...
                                    <p class="post-user-info">
                                     	<a href="#"> <%= ud.getUserByUserId(p.getId()).getName()%></a> has posted : 	
                                     </p>
                                </div>
